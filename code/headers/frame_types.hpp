...
namespace r2d2 {
    ...
    */
    ...
    R2D2_INTERNAL_FRAME_HELPER(frame_request_map_obstacles_s, REQUEST_MAP_OBSTACLES)
    R2D2_INTERNAL_FRAME_HELPER(frame_map_info_s, MAP_INFO)
    R2D2_INTERNAL_FRAME_HELPER(frame_map_obstacle_s, MAP_OBSTACLE)
